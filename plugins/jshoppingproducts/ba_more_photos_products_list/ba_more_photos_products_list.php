...
class plgJshoppingProductsBa_more_photos_products_list extends JPlugin
{
    ...
    public function __construct($subject, $config)
    {
        ...
        if (isset($this->_params->enable) && $this->_params->enable == 1 && isset($this->_params->count_images) && $this->_params->count_images > 1) {
            ...
            $doc->addStyleSheet(\JURI::root() . 'plugins/jshoppingproducts/ba_more_photos_products_list/ba_more_photos_products_list.css?ver=0.0.5');
            ...
            $doc->addScript(\JURI::root() . 'plugins/jshoppingproducts/ba_more_photos_products_list/ba_more_photos_products_list.js?ver=0.0.5');
        }
    }
